  ...
  _createClass(Range, [{
    ...
    value: function setElements() {
      ...
      var _this$$element$datase = this.$element.dataset,
          ...
          minValue = _this$$element$datase.minValue,
          maxValue = _this$$element$datase.maxValue,
      ...
      thumbLeft.style.left = "".concat(minValue, "%");
      range.style.left = "".concat(minValue, "%");
      range.style.right = "".concat(max - maxValue, "%");
      thumbRight.style.left = "".concat(maxValue - 2, "%"); // range.style.right = `${parseInt(minValue, 10) -3}%`;
    ...
    value: function setEvents() {
      ...
      inputRight === null || inputRight === void 0 ? void 0 : inputRight.addEventListener('input', function () {
        ...
        var percent = (inputValue - min) / (max - min) * 100;
        thumbRight.style.left = "".concat(percent - 2, "%");
