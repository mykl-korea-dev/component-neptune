...
(0, _utils.getData)("http://localhost:3000/imageSlide", function (data) {
  return new Certificate(document.querySelector('#certificate .slider-group'), data.certificate);
});
