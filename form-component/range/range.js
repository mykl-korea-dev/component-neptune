...
var Range = /** @class */ (function (_super) {
    ...
    Range.prototype.setTemplate = function () {
        ...
        var _b = this.$element.dataset, min = _b.min, max = _b.max, value = _b.value, step = _b.step;
        ...
        range.style.right = "".concat(value, "%");
        thumbRight.style.right = "".concat(value, "%");
    };
    ...
    Range.prototype.setEvents = function () {
        ...
        inputRight === null || inputRight === void 0 ? void 0 : inputRight.addEventListener('input', function (e) {
            ...
            var percent = ((inputValue - min) / (max - min)) * 100;
            console.log(percent);
            thumbRight.style.right = "".concat(100 - percent, "%");
